...
import type { AuthResult, GetAuthResult } from '../types'
...
export function createAuthenticatedClient(request: NextRequest): AuthResult {
...
export async function getAuthenticatedUser(request: NextRequest): Promise<GetAuthResult> {
