...
import type { SomiBlock, MediaItem } from '../types'

let videoBlocksCache: SomiBlock[] | null = null
...
async function fetchVideoBlocks(): Promise<SomiBlock[]> {
...
function blockToMedia(block: SomiBlock | null): MediaItem {
  if (!block) {
