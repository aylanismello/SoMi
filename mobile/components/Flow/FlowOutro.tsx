...
export default function SoMiCheckIn(): React.JSX.Element {
  ...
  const journalInputRef = useRef<RNTextInput | null>(null)
  ...
  const saveEmbodimentCheck = async (energy: number, safety: number, journal: string | null = null, tags: string[] | null = null) => {
  ...
  const handleFinish = async () => {
    ...
    if (isDaily) {
      ...
      ;(navigation as any).navigate('FlowCompletion')
