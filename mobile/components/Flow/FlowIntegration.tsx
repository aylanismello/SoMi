...
interface FlowIntegrationProps {
  oceanPlayer: VideoPlayer
  oceanOpacity: Animated.Value
  previewPlayer: VideoPlayer
  currentVideo: { name?: string; media_url?: string } | null
  isPaused: boolean
  messageIndex: number
...
export default function FlowIntegration({
  ...
  onExit,
  onOpenSettings,
}: FlowIntegrationProps): React.JSX.Element {
  return (
