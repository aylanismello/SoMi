...
import type { GroundingQuote, StreakDay } from '../types'
...
function WeekDay({ label, percentage, isToday, isFuture }: WeekDayProps): React.JSX.Element {
  const SIZE = 40
...
export default function HomeScreen(): React.JSX.Element {
  ...
  const [groundingQuote, setGroundingQuote] = useState<GroundingQuote | null>(null)
  const [quoteLoading, setQuoteLoading] = useState(true)
  const [cachedWeekData, setCachedWeekData] = useState<StreakDay[] | null>(null)
  ...
  useEffect(() => {
    let cachedQuote: GroundingQuote | null = null
