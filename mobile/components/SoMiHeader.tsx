...
interface SoMiHeaderProps {
  onRightPress?: () => void
  rightIcon?: 'heart' | 'settings'
  style?: ViewStyle
}

// style prop allows each screen to control positioning (absolute for Home, padding for others)
export default function SoMiHeader({ onRightPress, rightIcon = 'heart', style }: SoMiHeaderProps): React.JSX.Element {
