...
import type { SomiBlock } from '../types'
...
const getStateInfo = (video: SomiBlock) => {
...
const sortByStateTarget = (videos: SomiBlock[]) => {
...
export default function CategoryDetailScreen(): React.JSX.Element {
  ...
  const categoryColors = params.categoryColors ? JSON.parse(params.categoryColors as string) : ['#111', '#222']
  const [videos, setVideos] = useState<SomiBlock[]>([])
  ...
  const handleVideoPress = (video: SomiBlock) => {
        ...
        {loading ? (
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              We're preparing new {String(categoryName).toLowerCase()} practices for you
            </Text>
          </View>
        ) : (
